...
import { FeatHomeHouseHoldProd } from '../db';
import  '../css/ProductDetails.css'
import Navbar from '../Components/Navbar';
import Footer from '../Components/Footer';
const FeaturedHouseProductDetails = () => {
    const  {slug}  = useParams();
    const product = FeatHomeHouseHoldProd[slug];
...
export default FeaturedHouseProductDetails